...
<!-- Mirrored from html.fleexstudio.com/politico/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Dec 2024 09:35:18 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Adorable Foundation || Error</title>
    <!-- fav icon -->
...
<body>   
    ...
    <header>
        <div class="po-header-area d-none d-lg-block stiky">
            <div class="container po-header-bg">
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-6 col-6">
                        <div class="po-logo">
                            <a href="index"><img src="assets/img/logo/logo1.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-8 d-none d-lg-block">
                        <div class="po-main-menu text-center">
                            <ul>
                    ...
                    <div class="col-lg-2 col-md-6 col-6">
                        <div class="po-header-btn text-end">
    ...
    <div class="mobile-header mobile-header-main d-block d-lg-none">
      ...
      <div class="mobile-sidebar d-block d-lg-none">
        <div class="logo-m">
          <a href="index"><img src="assets/img/logo/ogo1.png" alt=""></a>
        </div>
...
<main>
         ...
         <section class="breadcrumb-bg">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6">
                        <div class="po-breadcrumb">
                            <h1 class="font-bold text-64 leading-64 text-white">404 Error</h1>
                            <div class="po-breadcrumb-list">
                                <span><a href="index.html">Home</a></span>
                                <span class="dvir"><i class="fa-solid fa-angle-right"></i></span>
                                <span class="active"><a href="#">404 error</a></span>
                            </div>
                        </div>
                    </div>
                </div>
           ...
           <!-- 404 section start -->
            <section class="po-error-section pt-100 pb-70">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12 text-center">
                            <div class="po-err-bg">
                                <div class="po-eror-img">
                                    <img class="w-100" src="assets/img/about/error.png" alt="">
                                </div>
                                <div class="po-eror-cont">
                                    <h2 class="font-bold text-48 leading-60">OPPS! This Page Are
                                        Can’t Be Found</h2>

                                    <p>We can’t  find this page your looking for</p>


                                    <div class="po-eror-page-btn">
                                        <a href="index.html" class="po-btn-sec po-btn-sec-1">
                                            <span class="po-btn-wrap">
                                                <span class="po-btn-y-1">Back To Home Page</span>
                                                <span class="po-btn-y-2">Back To Home Page</span>
                                            </span>
                                        </a>
                                    </div>
                                </div>
         ...
         <!-- cta section strat -->
         <section class="cta-section relative pt-80 pb-80" style="background-image: url(assets/img/banner/banner2.png);">
            <div class="container">
                <div class="po-cta-content text-center">
                    <div class="po-cta-icon">
                        <a href="#"><img src="assets/img/icon/po-download-1.1.svg" alt=""></a>
                    </div>
                    <h3 class="po-cta-title text-white font-bold text-40 leading-50 pt-32 pb-16">It’s Charity Day-Go Vote!<br>
                        Join the Foundation</h3>
    ...
    <footer>
        <!-- footer section start -->
         <div class="po-footer-section footer-bg-1 pt-80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 pb-32">
                        <div class="po-footer widget-1">
                            ...
                            <p class="pt-20 pb-24">Thank you for visiting Charity website. We're committed to transparency, inclusivity & making difference in our community Your support and engagement are vital.</p>
                            <div class="po-social">
                                <ul>
                    ...
                    <div class="col-lg col-md-6 pb-32">
                        <div class="po-footer widget-2">
                            <h4 class="po-footer-widget-title text-20 leading-20 font-bold pb-11">Quick Links</h4>
                            <div class="po-footer-menu">
                                <ul>
                                    <li><a href="index">Home</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 pb-32">
                        <div class="po-footer widget-4">
                            <div class="po-footer-ic-box bg-white rounded-100 p-24 d-flex items-center mb-20">
                                <div class="po-footer-icon mr-10">
                ...
                <div class="po-border-top"></div>
                <p class="copyright-1 leading-16 pt-24 pb-32 text-center">&COPY;Copyright 2024  Designed by Bamii Tech</p>
